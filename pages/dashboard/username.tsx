                        ...
                        <div className="relative mb-0 w-full flex  flex-col  laptop:rounded-lg laptop:mx-2 text-white phone:justify-center phone:items-center tablet:justify-end items-end">
                            <div className='w-full flex justify-center mb-4'>
                                <form onSubmit={handleSubmit(onSearch)} className="input-group relative flex mt-2 phone:w-[95%]  tablet:w-1/2 phone:ml-0 flex-wrap w-1/2 items-stretch w-full mb-0">
                                    <input type="search" {...register('key')}  className="usernamesearch form-control  relative flex-auto min-w-0 block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:outline-none" placeholder="Exemple: @username; username; user name" aria-label="Search" aria-describedby="button-addon2" />
